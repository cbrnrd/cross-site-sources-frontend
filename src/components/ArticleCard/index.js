  ...
  return (
    ...
    <div className="bg-white rounded-lg shadow-md p-4">
      ...
      <div className="flex items-center justify-between">
        ...
        { isLoggedIn ? 
          (<button className="bg-red-500 hover:bg-red-600 text-white px-2 py-1 rounded-md active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none"><i
          className="far fa-thumbs-up" onClick={likeArticle}></i> Like</button>) :
